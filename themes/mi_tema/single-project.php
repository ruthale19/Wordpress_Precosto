	...
	<?php if ( $post_type == 'project' ) { ?>
		...
		<div class="container px-5">
			...
			<a href="proyectos" class="btn btn-color btn-letter btn-sm my-5">Volver a proyectos <i class="far fa-folder-open"></i></a>
				...
				<h3 class="text-center my-5 font-weight-bold"> <?php the_field( 'obra' ); ?> </h3>

				<div class="text-center my-5">
					<?php $image1 = get_field( 'image1' ); ?>
					<?php if ( $image1 ) { ?>
						<img src="<?php echo $image1['url']; ?>" alt="<?php echo $image1['alt']; ?>" style="width: 1000px; height: 400px;"/>
					<?php } ?>
				</div>
				...
				<div class="text-center my-5">
					...
					<?php if ( $image2 ) { ?>
						<img src="<?php echo $image2['url']; ?>" alt="<?php echo $image2['alt']; ?>" style="width: 1000px; height: 400px;"/>
					<?php } ?>
				</div>
				...
				<div class="text-center my-5">
					...
					<?php if ( $image3 ) { ?>
						<img src="<?php echo $image3['url']; ?>" alt="<?php echo $image3['alt']; ?>" style="width: 1000px; height: 400px;"/>
					<?php } ?>
				</div>
				...
				<div class="text-center my-5">
					...
					<?php if ( $image4 ) { ?>
						<img src="<?php echo $image4['url']; ?>" alt="<?php echo $image['alt']; ?>" style="width: 1000px; height: 400px;"/>
					<?php } ?>
				</div>
