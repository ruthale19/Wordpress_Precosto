...
function dl_enqueue_style() {
	...
	wp_register_style( 'fonts', 'https://fonts.googleapis.com/css?family=Orbitron:700,900|Roboto:300,400,700&display=swap');
	wp_register_style( 'main_style', get_theme_file_uri('/assets/css/style.css'), $deps, $theme_data->get('Version'), 'screen' );
	wp_register_style( 'animate', get_theme_file_uri('/assets/css/animate.css'), $deps, $theme_data->get('Version'), 'screen' );
