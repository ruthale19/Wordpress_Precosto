...
function dl_enqueue_scripts() {
	...
	wp_register_script( 'wow', get_theme_file_uri('/assets/js/wow.js'), $deps, $theme_data->get( 'Version' ), true );
	wp_register_script( 'my_script', get_theme_file_uri('/assets/js/myscript.js'), $deps, $theme_data->get( 'Version' ), true );
